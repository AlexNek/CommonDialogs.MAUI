namespace CommonDialogs.Maui
{
    ...
    internal partial class FileSystemOperations : IFileSystemOperations
    {
        ...
        public FileSystemPickResult? CreateFile(string platformFolderPath, string childPath)
        {
        ...
        /// <param name="childPath">"etc,folder/file.txt or file.txt"</param>
        /// <returns>System.Nullable&lt;FilePickResult&gt;.</returns>
        public FileSystemPickResult? CreateFolder(string platformFolderPath, string childPath)
        {
        ...
        public Task<FileSystemPickResult?> PickFileAsync(FilePickOptions? pickOptions)
        {
        ...
        public Task<IEnumerable<FileSystemPickResult>> PickFilesAsync(FilePickOptions? pickOptions)
        {
        ...
        /// <returns>Task&lt;System.Nullable&lt;FilePickResult&gt;&gt;.</returns>
        public Task<FileSystemPickResult?> PickFolderAsync(FilePickOptions? pickOptions)
        {
